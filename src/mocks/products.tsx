...
export const products = [
   ...
   },
   {
       ...
       price: 160,
       color: 'Natural Black',
       description: 'Modelo de cano médio em lã merino, impermeável e elegante. Oferece estabilidade extra, conforto térmico e proteção ideal para dias frios e úmidos.', category:{id: 1, name: "Masculino"}
   },
   {
       id: 8,
