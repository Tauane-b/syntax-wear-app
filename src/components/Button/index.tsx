...
export const Button = ({ children, variant = "primary", size = "md" }: ButtonProps) => {
  const buttonStyles = {
    base: "flex justify-center  items-center  gap-2 text-nowrap leading-none hover:curson-pointer transiton-colors duration-200 font-medium rounded-full transution py-2.5 ",
    variant: {
